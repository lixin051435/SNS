...
<body>
<s:set value="id" var="userId" scope="session"></s:set>
<!-- Container Start-->
<div class="container_16" style="padding-left:15px;">
    ...
    <div class="grid_8 margin">
    	<div class="title-2cloumb">
        	<h1 style="text-align: right">注册成功</h1>
        	<p style="text-align: right">Successful registration</p>
        </div>
        <div class="comment-form margin">
           <div class="fright"><fieldset><input type="button" value="确定" onclick="window.location='user!list'"/></fieldset></div>
        </div>
    </div>
    <!-- Bigg Boss End -->
