...
<div class="container_16" style="padding-left:15px;">
    ...
    <div class="grid_16 margin">
        ...
        <div class="bigtitle">
        	<h1>会员<s:property value="#user.username"/>的个人信息</h1>
    ...
    <div class="grid_8 margin">
 	...
 	<form action="user!upload"  method="post" enctype="multipart/form-data">
 			<br><br>个人头像：<img alt="" width="60" height="60" src="<s:property value='#user.img'/>">
			<br><br>用户名：<s:property value="#user.username"/>
           	<br><br>上传头像： <input type="file" name="img" />
           	<br><br>住址：<s:property value="#user.address"/>
           	<br><br>tel：<s:property value="#user.tel"/>
           	<br><br>个人主页：<s:property value="#user.web"/>
           	<br><br>Email：<s:property value="#user.email"/>
           	<br>
           	<br>
           	<br>
						  <input type="submit" value="上传个性图像" >
    </form>
        </div>
    </div>
    <!-- Bigg Boss End -->
