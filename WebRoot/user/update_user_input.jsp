...
<div class="container_16" style="padding-left:15px;">
    ...
    <div class="grid_8 margin leftsays" style="padding-top:95">
    ...
    <div class="grid_8 margin" >
        ...
        <input type="hidden" name="password" value="<s:property value="#user.password"/>">
        	个人头像：<img alt="" width="60" height="60" src="<s:property value='#user.img'/>">
            <br><br><fieldset>用户名:<input name="username" type="text" value="<s:property value="#user.username"/>" /></fieldset>  
            <fieldset>家庭住址:<input name="address" type="text" value="<s:property value="#user.address"/>" /></fieldset>  
            <fieldset>联系电话:<input name="tel" type="text" value="<s:property value="#user.tel"/>" /></fieldset>  
            <fieldset>web:<input name="web" type="text" value="<s:property value="#user.web"/>" /></fieldset>  
           <fieldset>E-Mail:<input name="email" type="text" value="<s:property value="#user.email"/>" /></fieldset>
            <fieldset>个性签名<textarea name="descp"  ><s:property value="#user.descp"/></textarea></fieldset>
