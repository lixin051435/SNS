...
<div class="container_16" style="padding-left:15px;">
	...
	<fieldset>
		...
		<div>
			...
			<input type="text" name="source" id="source" value="" size="60" maxlength="200" /> 
			*(最多200个字符)<br />	
		</div>
		<div>
			<label for="author">文章作者</label>
			<input type="text" name="author" id="author" value="" size="60" maxlength="200" /> 
			*(最多200个字符)<br />	
		</div>
		<div>
		...
		<div>
			...
			<textarea rows="20" cols="100" name="descp" id="descp"></textarea>
			<br/>	
		</div>
		<div class="enter">
