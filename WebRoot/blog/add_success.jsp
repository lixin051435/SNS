...
<div class="container_16" style="padding-left:15px;">
    ...
    <div class="grid_8 margin">
    	<div class="title-2cloumb">
        	<h1 style="text-align: right">日志添加成功</h1>
        	<p style="text-align: right">查看日志 </p>
        </div>
        <div class="comment-form margin">
           <div class="fright"><fieldset><input type="button" value="确定" onclick="window.location='blog!list'"/></fieldset></div>
        </div>
    </div>
    <!-- Bigg Boss End -->
